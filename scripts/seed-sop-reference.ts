...
${statusTable([
  ...
  ["Waiting On Information", "Waiting on information from a team member or customer to proceed."],
...
${statusTable([
  ...
  ["Partial Pass", "Passed with minor items — does NOT proceed to PTO until fully passed."],
...
${statusTable([
  ...
  ["Partial Pass", "Inspection partially passed — does NOT proceed to PTO until fully passed."],
