...
const OPERATIONS_MANAGER: RoleDefinition = {
  ...
  allowedRoutes: [
    ...
    "/dashboards/product-requests-review",
    "/api/product-requests",
...
const ACCOUNTING: RoleDefinition = {
  ...
  visibleInPicker: true,
  suites: ["/suites/accounting", "/suites/pe-compliance"],
  allowedRoutes: [
    "/",
    "/suites/accounting",
    "/suites/pe-compliance",
    "/dashboards/payment-tracking",
    "/dashboards/payment-timeline",
    "/dashboards/payment-action-queue",
    "/dashboards/ready-to-invoice",
