...
export const queryKeys = {
  ...
  funnel: {
    ...
    designFunnel: (locations?: string[], leads?: string[], pms?: string[]) =>
      [...queryKeys.funnel.root, "design-funnel", locations, leads, pms] as const,
    ...
    milestoneCohort: (
      ...
      [...queryKeys.funnel.root, "milestone-cohort", milestone, start, end, locations, pms, owners] as const,
  },
  territoryMap: {
  ...
  designHub: {
    root: ["design-hub"] as const,
    queue: (tab: string) => [...queryKeys.designHub.root, "queue", tab] as const,
    project: (tab: string, dealId: string) =>
      [...queryKeys.designHub.root, "project", tab, dealId] as const,
    assignments: () => [...queryKeys.designHub.root, "assignments"] as const,
  },
  piHub: {
  ...
  propertyPermits: {
    ...
    list: (propertyId: string) => ["propertyPermits", propertyId] as const,
  },
  propertyResidents: {
    root: ["propertyResidents"] as const,
    list: (propertyId: string) => ["propertyResidents", propertyId] as const,
  },
  paymentTracking: {
