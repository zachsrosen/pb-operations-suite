...
export const UPDATES: UpdateEntry[] = [
  ...
  },
  {
    ...
    changes: [
      { type: "feature", text: "Extended schema for system sync: added `zohoItemId` on `EquipmentSku` and `zohoPoId` on `ProjectBomSnapshot`, plus migration support for both columns" },
