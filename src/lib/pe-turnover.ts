...
// ---------------------------------------------------------------------------
// Re-export client-safe checklist data from pe-photo-shots.ts
// (Keeps all existing server-side imports + Jest mocks working unchanged.)
// ---------------------------------------------------------------------------

import type { SystemType, ChecklistItem } from "@/lib/pe-photo-shots";
import { PE_M1_CHECKLIST } from "@/lib/pe-photo-shots";

export type { SystemType, ChecklistItem };
export { PE_M1_CHECKLIST };
...
// ChecklistResult and downstream types remain server-only (they reference DriveGenericFile etc.)
...
// (PE_M1_CHECKLIST is now imported from pe-photo-shots above and re-exported.)

// Local shorthands for M2 checklist and any remaining server-side logic.
