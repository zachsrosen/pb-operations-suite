...
import { isTeamActivityEnabled, TEAM_ACTIVITY_FLAG_KEY } from "@/lib/team-activity/flag";
      ...
      <DashboardShell title="Team Activity" accentColor="purple">
        <div className="bg-surface border border-t-border rounded-lg p-6 text-foreground">
          ...
          <p className="text-sm text-muted">
            Set the <code className="font-mono">{TEAM_ACTIVITY_FLAG_KEY}</code> SystemConfig row to <code className="font-mono">true</code> to enable this dashboard.
          </p>
