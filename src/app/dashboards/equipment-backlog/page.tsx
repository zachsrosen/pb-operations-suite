    ...
    >
      ...
      {view === "summary" ? (
        <>
          ...
          <StatRow label="Backlog" totals={backlogTotals} accent="bg-cyan-400" cls="backlog" activeStatFilter={activeStatFilter} onStatRowClick={handleStatRowClick} />
          <StatRow label="In Progress (Construction)" totals={inProgressTotals} accent="bg-orange-400" cls="in_progress" activeStatFilter={activeStatFilter} onStatRowClick={handleStatRowClick} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
            <ProductBreakdown title="Modules" items={moduleProducts} color="text-blue-400" typeKey="modules" expandedProduct={expandedProduct} onToggleExpand={toggleProductExpand} />
            <ProductBreakdown title="Inverters" items={inverterProducts} color="text-purple-400" typeKey="inverters" expandedProduct={expandedProduct} onToggleExpand={toggleProductExpand} />
            <ProductBreakdown title="Batteries" items={batteryProducts} color="text-emerald-400" typeKey="batteries" expandedProduct={expandedProduct} onToggleExpand={toggleProductExpand} />
            <ProductBreakdown title="Battery Expansion" items={batteryExpProducts} color="text-green-400" typeKey="batexp" expandedProduct={expandedProduct} onToggleExpand={toggleProductExpand} />
            <ProductBreakdown title="EV Chargers" items={evProducts} color="text-pink-400" typeKey="ev" expandedProduct={expandedProduct} onToggleExpand={toggleProductExpand} />
          </div>
        </>
      ) : (
        /* ---- Projects Table View ---- */
                ...
                <thead className="sticky top-0 bg-surface/95 backdrop-blur-sm z-10">
                  <tr className="text-muted text-left border-b border-t-border">
                    ...
                    <th className="px-4 py-3 cursor-pointer hover:text-foreground" onClick={() => handleSort("location")}>
                      Location <SortIcon field="location" sortField={sortField} sortDir={sortDir} />
                    </th>
                    ...
                    <th className="px-4 py-3 cursor-pointer hover:text-foreground text-right" onClick={() => handleSort("modules")}>
                      Modules <SortIcon field="modules" sortField={sortField} sortDir={sortDir} />
                    </th>
