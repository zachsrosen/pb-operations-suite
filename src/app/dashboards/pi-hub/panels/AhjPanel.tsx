 ...
 * where a number of days was meant (#1483). The object's own
 * `permit_turnaround_average` text field corroborates the conversion — Arvada
 * 2002560000ms = 23.2d vs "24", Aurora 705600000ms = 8.2d vs "8", Atascadero
 * 5085257142ms = 58.9d vs "59".
 *
