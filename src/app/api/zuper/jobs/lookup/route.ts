...
export async function handleLookup(projectIds: string[], projectNames: string[], category: string | null) {
  ...
  const CATEGORY_ALIASES: Record<string, string> = {
    ...
    // Pre-Sale Site Visit is bucketed alongside Site Survey for scheduler purposes
    "pre-sale site visit": JOB_CATEGORIES.SITE_SURVEY,
    "pre-sale": JOB_CATEGORIES.SITE_SURVEY,
    [JOB_CATEGORY_UIDS.PRE_SALE_SITE_VISIT.toLowerCase()]: JOB_CATEGORIES.SITE_SURVEY,
