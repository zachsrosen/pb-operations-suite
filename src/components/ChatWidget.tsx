...
const HIDDEN_PATHS = ["/dashboards/scheduler", "/dashboards/construction-scheduler", "/dashboards/site-survey-scheduler", "/dashboards/inspection-scheduler", "/dashboards/office-performance", "/estimator"];
