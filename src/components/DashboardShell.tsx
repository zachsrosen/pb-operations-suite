...
const SUITE_MAP: Record<string, { href: string; label: string }> = {
  ...
  "/dashboards/eagleview-orders": { href: "/suites/operations", label: "Operations" },
  ...
  "/dashboards/pe-report": { href: "/suites/accounting", label: "Accounting" },
  ...
  "/dashboards/monthly-activity": { href: "/suites/executive", label: "Executive" },
